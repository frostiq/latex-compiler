...
public class MyFrame extends JFrame implements ActionListener{
	...
	JMenuItem opfile = new JMenuItem("Открыть файл");
	JMenuItem defile = new JMenuItem("Выбрать файл по умолчанию");
	JMenuItem svfile = new JMenuItem("Сохранить преобразованный файл");
	...
	public void printText(File f) throws IOException
	{
